...
const config: ApplicationConfiguration = {
    ...
    traceExporterUrl: process.env.OTEL_TRACE_EXPORTER_URL ?? "https://internalapi.cidev.aws.chdev.org/v1/traces",
    metricsExporterUrl: process.env.OTEL_METRICS_EXPORTER_URL ?? "https://internalapi.cidev.aws.chdev.org/v1/metrics"
};
