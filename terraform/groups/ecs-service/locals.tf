...
locals {
  ...
  task_environment = concat(local.ssm_global_version_map,local.ssm_service_version_map,[
    ...
    { "name" : "OTEL_RESOURCE_ATTRIBUTES", "value" : "aws.log.group.arns=arn:aws:logs:eu-west-2:169942020521:log-group:/ecs/search-service-cidev/eric/restricted-word-web-otel:*" }
  ])
}